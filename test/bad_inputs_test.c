...
static unsigned char data2[] = {0x9D};
...
static unsigned char data3[] = {0xD6};
...
#ifdef SANE_MALLOC
static unsigned char data4[] = {0xBA, 0xC1, 0xE8, 0x3E, 0xE7, 0x20, 0xA8};
...
static unsigned char data5[] = {0x9A, 0xDA, 0x3A, 0xB2, 0x7F, 0x29};
...
static unsigned char data6[] = {0x7F, 0x21, 0x4C, 0x02, 0x40};
...
static unsigned char data7[] = {0xA2, 0x9B, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static unsigned char data8[] = {0xA3, 0x64, 0x68, 0x61, 0x6C, 0x66, 0xFF, 0x00,
...
static unsigned char data9[] = {0xBF, 0x05, 0xFF, 0x00, 0x00, 0x00, 0x10, 0x04};
...
#define main cbor_bad_inputs_test_main
#endif
